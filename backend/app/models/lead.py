...
class Lead(Base):
    ...
    parent_contact_number: Mapped[str] = mapped_column(String(20), nullable=True)
    school_name: Mapped[str] = mapped_column(String(150), nullable=True)
    ...
    # ── NEW COLUMNS ──────────────────────────────────────────────────────────
    board_name: Mapped[str] = mapped_column(String(100), nullable=True)
